package me.raining.gateway.core.netty;
...
import me.raining.gateway.common.utils.RemotingUtil;
import me.raining.gateway.core.Config;
import me.raining.gateway.core.LifeCycle;
...
public class NettyHttpServer implements LifeCycle {
     ...
     * 构造方法，用于创建Netty服务器实例
     * @param config 网关核心配置
     * @param nettyProcessor 自定义的nettyProcessor
     */
